...
describe("UserProfileCard", () => {
  test("should props display correct infos", async () => {
  ...
  test("should userInfos props update successfully", async () => {
    const wrapper = mount(UserProfileCard, {
      props: {
        userInfos: {
          userName: "",
  ...
  test("should isEditMode to be false on the beginning", async () => {
    const wrapper = mount(UserProfileCard);
    expect(wrapper.vm.isEditMode).toBe(false);
  });

  test("should isEditMode to be true", async () => {
    const wrapper = mount(UserProfileCard);
