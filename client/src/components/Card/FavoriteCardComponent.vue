...
<template>
  <CardLayout v-if="add">
    <template #image>
      <img :src="props.add.images[0]" class="favorite-card__image" alt="product-image" />
    </template>
    <template #title>
    ...
    <template #favorite>
      <div class="favorite-card__actions">
        <span @click="$emit('send-favorite', add)" @keydown="$emit('send-favorite', add)"><i class="fa fa-eye" aria-hidden="true"></i></span>
