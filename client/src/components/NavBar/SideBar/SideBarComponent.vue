...
import NavLink from "../NavLinkComponent.vue";
import SideBarContainer from "./SideBarContainer/SideBarContainerComponent.vue";
...
<template>
  ...
  >
    ...
    <div class="side-bar__items">
      <button v-if="state.isHover" class="side-bar__link--error" @click="logOut()" @keydown="logOut()" icon="fa-solid fa-right-from-bracket">Se déconnecter</button>
      ...
      <NavLink class="side-bar__link" to="/adds" icon="fa-solid fa-handshake-angle"><span>Annonces</span></NavLink>
      <NavLink class="side-bar__link" to="/create-add" icon="fas fa-pencil-alt"><span>Déposer une annonce</span></NavLink>
      <NavLink class="side-bar__link" to="/user-adds" icon="fas fa-pencil-alt"><span>Mes annonces</span></NavLink>
