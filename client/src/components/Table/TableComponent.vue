...
import TableLargeScreen from "@/components/Table/TableLargeScreenComponent.vue";
import TableSmallScreen from "@/components/Table/TableSmallScreenComponent.vue";
...
<template>
  <div class="table">
    <div v-if="props.userAdds.length > 0" class="table__content">
      <component :is="isActive" :user-adds="props.userAdds" :user-config="props.config" v-bind="$attrs" />
    </div>
