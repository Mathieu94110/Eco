...
import type { FiltersInterface, Category, FakeAddInterface } from "@/shared/interfaces";
...
<template>
  <div class="add-card-filter">
    <div class="add-card-filter__wrapper" :style="{ left: sideBarClosed ? '75px' : '270px' }">
      <section class="mb-20">
      ...
      <section>
        ...
        >
          <label for="priceRange">
            <input :checked="rangeFilter[0] === priceRange[0]" type="radio" @input="emit('update-filter', { priceRange })" name="priceRange" :id="priceRange[0] + ''" class="mr-10" />
          </label>
